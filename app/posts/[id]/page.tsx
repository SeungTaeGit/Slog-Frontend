  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F8F9FF] via-[#F1F5FF] to-[#FFFFFF] dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 pb-20 transition-colors duration-300">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fadeIn">
        ...
        <article className="bg-white/80 dark:bg-gray-800/60 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-12 shadow-2xl dark:shadow-none border border-white/60 dark:border-gray-700/50 relative overflow-hidden transition-colors">
           ...
           <div className="prose max-w-none text-gray-600 dark:text-gray-300 leading-relaxed whitespace-pre-line relative z-10">
             <ReactMarkdown
               components={{
                 h1: ({node, ...props}) => <h1 className="text-3xl font-bold mt-8 mb-4 text-gray-900 dark:text-gray-100 border-b dark:border-gray-700 pb-2" {...props} />,
                 h2: ({node, ...props}) => <h2 className="text-2xl font-bold mt-6 mb-3 text-gray-800 dark:text-gray-200" {...props} />,
